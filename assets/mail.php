<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ( empty($name) OR empty($name_2) OR empty($subject) OR empty($website) OR empty($message) OR empty($phone) OR empty($checkbox) OR !filter_var($email, FILTER_VALIDATE_EMAIL)) {
